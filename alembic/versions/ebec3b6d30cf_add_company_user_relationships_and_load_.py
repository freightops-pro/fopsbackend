"""Add company user relationships and load board system

Revision ID: ebec3b6d30cf
Revises: 2fabcc67f536
Create Date: 2025-10-19 20:23:51.887109
...
revision: str = 'ebec3b6d30cf'
down_revision: Union[str, None] = '2fabcc67f536'
...
def upgrade() -> None:
    ...
    op.create_table('broker_commissions',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('load_id', sa.String(), nullable=False),
    sa.Column('broker_company_id', sa.String(), nullable=False),
    sa.Column('carrier_company_id', sa.String(), nullable=False),
    sa.Column('total_load_value', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    sa.ForeignKeyConstraint(['load_id'], ['simple_loads.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_broker_commissions_broker', 'broker_commissions', ['broker_company_id', 'payment_status'], unique=False)
    op.create_index('idx_broker_commissions_carrier', 'broker_commissions', ['carrier_company_id'], unique=False)
    op.create_index('idx_broker_commissions_load', 'broker_commissions', ['load_id'], unique=False)
    op.create_index('idx_broker_commissions_payment', 'broker_commissions', ['payment_status', 'payment_date'], unique=False)
    op.create_table('load_board',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('broker_company_id', sa.String(), nullable=False),
    sa.Column('load_id', sa.String(), nullable=False),
    ...
    sa.Column('booking_requests', sa.JSON(), nullable=True),
    sa.Column('carrier_company_id', sa.String(), nullable=True),
    sa.Column('booking_confirmed_at', sa.DateTime(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['broker_company_id'], ['companies.id'], ),
    sa.ForeignKeyConstraint(['carrier_company_id'], ['companies.id'], ),
    ...
    op.create_index('idx_load_board_available', 'load_board', ['is_available', 'created_at'], unique=False)
    op.create_index('idx_load_board_broker', 'load_board', ['broker_company_id', 'is_available'], unique=False)
    op.create_index('idx_load_board_carrier', 'load_board', ['carrier_company_id'], unique=False)
    op.create_index('idx_load_board_load', 'load_board', ['load_id'], unique=False)
    ...
    op.create_index('idx_company_users_company', 'company_users', ['company_id', 'is_active'], unique=False)
    op.create_index('idx_company_users_role', 'company_users', ['company_id', 'role'], unique=False)
    op.create_index('idx_company_users_user', 'company_users', ['user_id', 'is_active'], unique=False)
    op.create_table('load_bookings',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('load_board_id', sa.String(), nullable=False),
    sa.Column('carrier_company_id', sa.String(), nullable=False),
    sa.Column('requested_rate', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('message', sa.String(), nullable=True),
    sa.Column('status', sa.String(), nullable=False),
    sa.Column('broker_response', sa.String(), nullable=True),
    sa.Column('broker_rate', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['carrier_company_id'], ['companies.id'], ),
    sa.ForeignKeyConstraint(['load_board_id'], ['load_board.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_load_bookings_board', 'load_bookings', ['load_board_id', 'status'], unique=False)
    op.create_index('idx_load_bookings_carrier', 'load_bookings', ['carrier_company_id', 'status'], unique=False)
    op.create_index('idx_load_bookings_status', 'load_bookings', ['status', 'created_at'], unique=False)
    ...
    conversation_type_enum = sa.Enum('DIRECT', 'TEAM', name='conversationtype')
    conversation_type_enum.create(op.get_bind(), checkfirst=True)
    
    # Update existing data to match enum values
    op.execute("UPDATE conversations SET conversation_type = 'DIRECT' WHERE conversation_type = 'direct'")
    op.execute("UPDATE conversations SET conversation_type = 'TEAM' WHERE conversation_type = 'team'")
    
    # Alter the column with USING clause
    op.execute("ALTER TABLE conversations ALTER COLUMN conversation_type TYPE conversationtype USING conversation_type::conversationtype")
...
def downgrade() -> None:
    ...
    op.alter_column('conversations', 'conversation_type',
               existing_type=sa.Enum('DIRECT', 'TEAM', name='conversationtype'),
    ...
    op.drop_index('idx_load_bookings_status', table_name='load_bookings')
    op.drop_index('idx_load_bookings_carrier', table_name='load_bookings')
    op.drop_index('idx_load_bookings_board', table_name='load_bookings')
    op.drop_table('load_bookings')
    op.drop_index('idx_company_users_user', table_name='company_users')
    op.drop_index('idx_company_users_role', table_name='company_users')
    op.drop_index('idx_company_users_company', table_name='company_users')
    ...
    op.drop_index('idx_load_board_load', table_name='load_board')
    op.drop_index('idx_load_board_carrier', table_name='load_board')
    op.drop_index('idx_load_board_broker', table_name='load_board')
    op.drop_index('idx_load_board_available', table_name='load_board')
    op.drop_table('load_board')
    op.drop_index('idx_broker_commissions_payment', table_name='broker_commissions')
    op.drop_index('idx_broker_commissions_load', table_name='broker_commissions')
    op.drop_index('idx_broker_commissions_carrier', table_name='broker_commissions')
    op.drop_index('idx_broker_commissions_broker', table_name='broker_commissions')
