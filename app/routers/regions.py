...
@router.get("/regions/{region_code}", response_model=RegionConfigResponse)
...
@router.get("/regions/{region_code}/fields", response_model=List[RegionalFieldResponse])
...
@router.get("/regions/{region_code}/requirements", response_model=List[RegionalRequirementResponse])
